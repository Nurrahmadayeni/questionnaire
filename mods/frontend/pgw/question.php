<?php
    ...
    $query = "SELECT *from survey where id_survey='$id_survey' and dsn=1 and objective='$_SESSION[id_unit]'";
                    ...
                    echo "
                        <div class='row'>
                            ...
                            <div class='col-md-3' style='text-align:right'>
                                <a href='?d=".base64_encode('dashboard_tampilan_home_pengguna')."' class='btn btn-default btn-push btn-sm' ><i class='fa fa-step-backward'></i> Kembali ke daftar survey </a>
                            </div>
                        </div>
                        <div class='row'>
