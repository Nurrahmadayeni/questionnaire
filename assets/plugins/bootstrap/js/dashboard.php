...
<body <?php if(!empty($_GET['d'])){ echo "class='page-sound page-header-fixed page-sidebar-fixed page-footer-fixed'"; } ?> >
    <section id="wrapper">
            ...
            <nav class="navbar navbar-toolbar navbar-fixed-top" style='background-color: #81B71A;'>
                <div class="nav navbar-nav navbar-left" style="color:white;">
                        ...
                        <?php
                            ...
                            if($_SESSION['level']=='fakultas'||$_SESSION['level']=='unit'||$_SESSION['level']=='super'){
                    ...
                    <li class="dropdown navbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="meta">
                                ...
                                <span class="text hidden-xs hidden-sm text-muted" style='color:white;'><?= $_SESSION['username_q'] ?></span>
        ...
        <?php if(!empty($_GET['d'])){ include ('mods/menu.php'); } ?>
        <?php $url = base64_decode($_GET['d']); 
            if($url=='tampilan_question_pengguna'){
                echo "  <div class='col-md-3' style='padding-left:-20px; margin-top:10px;'>
            <a href='../' class='btn btn-theme btn-push btn-md' ><i class='fa fa-step-backward'></i> Kembali ke daftar survey </a>
        </div>";
            }
        ?>
      
        <section class="body-content animated fadeIn container-fluid text-middle" <?php 
            if(!empty($_GET['d']) || $url=='tampilan_question_pengguna'){
