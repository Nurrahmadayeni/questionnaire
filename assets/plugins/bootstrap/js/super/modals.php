            ...
            <div class="modal-body">
                ...
                <form id='form_addUser' action="#" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 mb-15" multiple placeholder="-- Pilih Unit Kerja --" style="width: 100%;" name='unit' id='unit_user' required>
                        <option value="" disabled="">-- Pilih Unit Kerja --</option>
                        <?php include '../mods/frontend/admin/listUnFac.php' ?>
                        </select>
                    </div>
